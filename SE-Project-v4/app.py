...
def auditor_feedback(project_name):
    ...
    if request.method == 'POST':
        # Get feedback and conformance level from the form
        feedback_text = request.form.get('feedback_text')
        conformance_level = request.form.get('conformance_level')

        # Save feedback and conformance level indexed by project name
        feedback['auditor'] = {
